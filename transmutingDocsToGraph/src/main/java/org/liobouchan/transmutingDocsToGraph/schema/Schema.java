...
import org.liobouchan.transmutingDocsToGraph.results.StringResult;
...
public class Schema {
	...
	@Procedure(name="com.liobouchan.transmutingDocsToGraph.schema.generate", mode= Mode.SCHEMA)
	@Description("CALL com.liobouchan.transmutingDocsToGraph.schema.generate() - generate schema")
